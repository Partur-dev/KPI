...
ALTER table trolleybus
    ...
    ADD constraint chk_trolleybus_status
        check (status IN ('in_service', 'under_maintenance', 'decommissioned'));
...
-- F & G. Create roles
-- Analyst - readonly access to all tables
-- Mechanic - read access to trolleybus, brand and; read-write access to inspection
-- Dispatcher - read access to all tables, read-write access to route, route_stop and shift
