...
-- === extra route_stop for richer routes ===
INSERT INTO route_stop (route_number, stop_id, stop_order) VALUES
    ('R1',2,4),
    ('R1',3,5),
    ('R2',1,4),
...
-- === extra shifts to get multiple days, routes & 6+ shifts for some trolleybuses ===
INSERT INTO shift (driver_id, work_date, start_time, end_time, trolleybus_number, route_number) VALUES
    -- more shifts for TB-101 (will have > 5 shifts total)
    (1,'2025-11-02','06:00','08:00','TB-101','R1'),
    (1,'2025-11-03','06:00','08:00','TB-101','R1'),
    (2,'2025-11-02','08:15','10:15','TB-101','R2'),
    (3,'2025-11-02','10:30','12:30','TB-101','R3'),
    (4,'2025-11-04','06:30','08:30','TB-101','R4'),

    -- driver 2 on same route multiple times (for GROUP BY by driver+route)
    (2,'2025-11-03','09:00','11:00','TB-102','R2'),
    (2,'2025-11-04','09:00','11:00','TB-102','R2'),

    -- driver 5 on different routes (for route mix per driver)
    (5,'2025-11-02','11:00','13:00','TB-105','R5'),
    (5,'2025-11-03','11:00','13:00','TB-105','R6'),

    -- driver 10 with several days (for ORDER BY by date+time)
    (10,'2025-11-02','16:00','18:00','TB-110','R10'),
    (10,'2025-11-03','16:00','18:00','TB-110','R11');

-- === extra inspections so MAX(inspection_date) looks interesting ===
INSERT INTO inspection (trolleybus_number, inspection_date, results, inspector) VALUES
    ('TB-101','2025-11-01','Post-incident diagnostic','Andrii Kovalenko'),
    ('TB-110','2025-11-05','Changed tires','Dmytro Hlushko'),
    ('TB-115','2025-11-03','Replaced windshield','Ihor Maksymchuk');
